import{o,a,g as n}from"./index-Nm51fKLq.js";const i={class:"markdown-body"},p={__name:"install",setup(s,{expose:t}){return t({frontmatter:{}}),(d,e)=>(o(),a("div",i,[...e[0]||(e[0]=[n(`<h1 id="installation" tabindex="-1">Installation</h1><p><strong><code>@rukkiecodes/native</code></strong> is FusionUI for Expo + React Native — the same design language as the web, reimplemented for the phone. Add it to any Expo project.</p><h2 id="install" tabindex="-1">Install</h2><pre><code class="language-bash">npx expo install @shopify/react-native-skia react-native-reanimated expo-linear-gradient

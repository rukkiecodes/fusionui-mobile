...
</code></pre><p>Each component page has a <strong>runnable preview</strong> — a live Expo Snack of the actual component, opening on the clean demo with the real source one tab over — plus its usage and props.</p><p>Next: <a href="/components">browse the components →</a></p><hr><p>Components are adapted from <a href="https://github.com/rit3zh/reacticx">reacticx</a> (MIT © rit3zh), rebranded for FusionUI.</p>`,20)])]))}};export{p as default};
